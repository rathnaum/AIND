...
def custom_score(game, player):
    ...
    """
    return calculate_score(game, player, 1, 1.5)

def calculate_score(game, player, my_weight=1, opp_weight=1.5):
    ...
    def get_move(self, game, legal_moves, time_left):
        ...
        **********************************************************************
        ...
        try:
            ...
            # perform post timeout actions, if necessary
            pass

        # Return best move completed search iteration
        return move
